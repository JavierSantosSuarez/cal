...
<head>
	...
	<link rel="shortcut icon" href="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/favicon.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo get_bloginfo('stylesheet_directory'); ?>/images/apple-touch-icon-precomposed.png">
...
<div class="topbar">
	<ul>
		...
		<a href="http://twitter.com/ASM_clientes" target="_blank">  @ASM_clientes</a>
		</li>
		<li class="directline"><a href="#"><span  class="icon-info-sign icon-large"></span> 902 11 33 00</a></li>
		<li>
			<a title="Catal&agrave;" href="http://www.asmred.com/en/index.php?lang=ca" class="idioma-ca">Catal&agrave;</a>    
			<a title="English" href="http://www.asmred.com/en/index.php?lang=en" class="idioma-en">English</a>
			<a title="Espa&ntilde;ol" href="http://www.asmred.com" class="idioma-es" id="idioma-seleccionado">Espa&ntilde;ol</a>
			<a title="Euskara" href="http://www.asmred.com/en/index.php?lang=eu" class="idioma-eu">Euskara</a>
			<a title="Galego" href="http://www.asmred.com/en/index.php?lang=gl" class="idioma-gl">Galego</a>
			<a title="Valenci&agrave;" href="http://www.asmred.com/en/index.php?lang=va" class="idioma-va">Valenci&agrave;</a>
		</li>
	</ul>
	<div class="clear"></div>
</div>
...
<div class="social-buttons hidden-phone">
	...
	<div class="fb-like" data-href="https://www.facebook.com/oficialASM" style="position:relative;top:-2px ;" data-send="false" data-layout="button_count" data-width="50" data-show-faces="false"></div>
	
	<a href="https://twitter.com/ASM_oficial" class="twitter-follow-button" data-show-count="false" data-lang="en">Follow @asmred</a>
