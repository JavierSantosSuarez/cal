		...
		<tr>
			...
			<td width="300" valign="top" style="text-align:right;font-size:13px;color:#777;border-bottom:1px #DDD solid;">
				...
				<div style="text-align:right;">
					...
					<a href="https://www.facebook.com/oficialASM"><img src="<?php echo TEMPLATE_URL ?>/images/newsletter/facebook.png" border="0" alt="Facebook" title="" /></a>
					<a href="http://twitter.com/#!/ASM_oficial"><img src="<?php echo TEMPLATE_URL ?>/images/newsletter/twitter.png"  border="0" alt="Twitter" title="" /></a>
